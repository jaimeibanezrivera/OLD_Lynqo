...
class CameraApp:
    def __init__(self, window):
        ...
        self.model = InferenceHTTPClient(api_url="https://detect.roboflow.com",api_key="6SEBLtTLjfw8g1ltcCd2")
    ...
    def detect_objects(self):
        if self.camera:
            ...
            filename_img = f"image_{timestamp}.jpg"  # Convert BGR to RGB
            cv2.imwrite(filename_img, image_rgb)

            result = self.model.infer(inference_input=filename_img ,model_id="medicalcomponents/1")
